...
do
    ...
    sbatch launch_slurm.wilkes3 experiment=babylm_comparison_text model=$model tokenizer=babylm_text_char data_preprocessing.remove_word_boundaries=True experiment.name=$model-char-txt-spaceless
    ...
    sbatch launch_slurm.wilkes3 experiment=babylm_comparison_phoneme model=$model tokenizer=babylm_phoneme data_preprocessing.remove_word_boundaries=True experiment.name=$model-phoneme-spaceless
done